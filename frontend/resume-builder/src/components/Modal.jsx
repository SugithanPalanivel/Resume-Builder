...
const Modal = ({
  ...
  return <div className='fixed inset-0 z-50 flex justify-center items-center w-full h-full bg-black/40'>
    ...
    <div className={`relative flex flex-col bg-white shadow-lg rounded-lg overflow-hidden`}>
      ...
      <button
        type='button'
        className='text-gray-400 bg-transparent hover:text-gray-900 hover:bg-gray-200 rounded-lg text-sm w-8 h-8 flex justify-center items-center absolute top-3.5 right-3.5'
        onClick={onClose}
        >
            <svg 
            className='w-3 h-3'
