...
const TemplateThree = ({
    ...
    const [sacle,setScale]=useState(1);

    useEffect(()=>{
        // Calculate the scale factor based on the conatiner width
  ...
  return <div
            ...
            style={{
                transform: containerWidth > 0 ? `sacle(${sacle}) `: "none",
                transformOrigin:"top left",
                width: containerWidth > 0 ? `${baseWidth} px` : "auto", //keep the original size so scalling work correctly
                height:"auto",
